...
We will start by bringing in the figure extent feature class that was created above and use the [Extent to polygon](./Useful tools) tool to extract the footprint of the data frame layout.  These polygons will be used to 
...
Files that may be of interest for the map creation process include:
 ...
 - [Budding GDB Data Model](/Ref Docs): Presentation I gave on the Budding GDB data model presented at the [2016 MACURISA Conference](https://macurisa2016.sched.org/)
